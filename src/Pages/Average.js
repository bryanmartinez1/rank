...
function Average() {
  ...
  const [creditsReceived, setCreditsReceived] = useState(0);
  ...
  function addCourseFunction() {
    if (gradeMap.has(courseGrade) === false) {
      alert(
        "Invalid Course Grade, Please put in the form of (A+, A, A-, ..., D+, D, D-, or F)"
      );
      return;
    }
    if (courseCredits < 0) {
  ...
  return (
    <div className="bodyPart">
      ...
      <div className="credits">Credits Received: {creditsReceived}</div>
